...
func _build_color_section(parent: VBoxContainer) -> void:
	...
	_paint_picker.size_flags_horizontal = Control.SIZE_EXPAND_FILL
...
func _build_brush_section(parent: VBoxContainer) -> void:
	...
	_radius_spinbox.custom_minimum_size.x = 60
	...
	_strength_spinbox.custom_minimum_size.x = 60
